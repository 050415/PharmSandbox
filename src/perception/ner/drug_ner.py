...
_ZH_TO_EN: Dict[str, str] = {
    ...
    '甲硝唑': 'metronidazole',
    '头孢': 'cephalosporin',
    '头孢曲松钠': 'ceftriaxone', '头孢曲松': 'ceftriaxone',
    '头孢哌酮': 'cefoperazone', '头孢他啶': 'ceftazidime',
    '头孢克肟': 'cefixime', '头孢呋辛': 'cefuroxime',
    '葡萄糖酸钙': 'calcium gluconate', '氯化钾': 'potassium chloride',
    '硫酸镁': 'magnesium sulfate', '碳酸氢钠': 'sodium bicarbonate',
    '氯化钠': 'sodium chloride', '葡萄糖': 'glucose',
    '甘露醇': 'mannitol', '氨茶碱': 'aminophylline',
    '氨甲环酸': 'tranexamic acid', '酚磺乙胺': 'etamsylate',
    '硝酸异山梨酯': 'isosorbide dinitrate', '硝普钠': 'nitroprusside',
    '普罗帕酮': 'propafenone', '维拉帕米': 'verapamil',
    '卡托普利': 'captopril', '依那普利': 'enalapril',
    '双嘧达莫': 'dipyridamole', '华法林钠': 'warfarin',
    '低分子肝素': 'enoxaparin', '尿激酶': 'urokinase',
    '西咪替丁': 'cimetidine', '雷尼替丁': 'ranitidine',
    '甲氧氯普胺': 'metoclopramide', '昂丹司琼': 'ondansetron',
    '纳洛酮': 'naloxone', '亚甲蓝': 'methylene blue',
    '苯海拉明': 'diphenhydramine', '异丙嗪': 'promethazine',
    '氯雷他定': 'loratadine', '沙丁胺醇': 'albuterol',
    '异丙托溴铵': 'ipratropium', '布地奈德': 'budesonide',
    '孟鲁司特': 'montelukast', '可待因': 'codeine',
    '右美沙芬': 'dextromethorphan', '乙酰半胱氨酸': 'acetylcysteine',
    '青霉素': 'penicillin',
    '布洛芬': 'ibuprofen',
